...
# directory = r"P:\Thesis\Training\Ponce"
# directory = r"P:\Thesis\Test Data\Puerto Real"
# directory = r'P:\Thesis\Test Data\TinianSaipan'


maskSHP = r"P:\Thesis\Extents\FLKeys_Extents_DeepVessel.shp"
# maskSHP = r"P:\Thesis\Extents\FLKeys_Training.shp"
# maskSHP = r"P:\Thesis\Extents\StCroix_Extents.shp"
# maskSHP = r"P:\Thesis\Extents\Ponce_Obvious.shp"
# maskSHP = r"P:\Thesis\Extents\Puerto_Real_Smaller.shp"
# maskSHP = r"P:\Thesis\Extents\Saipan_Extents.shp"

predictor_dir = directory + '\_8Band_DeepVessel'
...
if full_workflow:
    ...
    # mTF, maskOutput, out_meta = sdb.mask_imagery(redInput, greenInput, blueInput, maskSHP, predictor_dir)
...
# %% - derivatives
    ...
    # blue_sobelTF, blue_sobel, bsobel_edges = sdb.sobel_filt(maskedBlue, sobel_name='blue_sobel.tif', output_dir=predictor_dir, out_meta=out_meta)
    # if blue_sobelTF:
    #     print(f'\nWrote: {blue_sobel}')
    # else:
    #     print('\nCreating blue sobel failed...')
    
    # green_sobelTF, green_sobel, gsobel_edges = sdb.sobel_filt(maskedGreen, sobel_name='green_sobel.tif', output_dir=predictor_dir, out_meta=out_meta)
    # if green_sobelTF:
    #     print(f'\nWrote: {green_sobel}')
    # else:
    #     print('\nCreating green sobel failed...')
        
    # red_sobelTF, red_sobel, rsobel_edges = sdb.sobel_filt(maskedRed, sobel_name='red_sobel.tif', output_dir=predictor_dir, out_meta=out_meta)
    # if red_sobelTF:
    #     print(f'\nWrote: {red_sobel}')
    # else:
    #     print('\nCreating red sobel failed...')    
...
# %% -- ratio of logs between bands / relative bathymetry
    ...
    compTF, composite, n_bands = sdb.composite(dir_list, output_composite)
    
    if compTF:
        print(f'\nWrote: {composite} with {n_bands} bands')
    else:
